...
namespace Types.Board {
    public interface IBoardNeuronsController : IBoardElementsController<IBoardNeuron> {
        ...
        bool AddNeuron(IBoardNeuron neuron, Hex.Coordinates.Hex hex, bool activate = true);

        void RemoveNeuron(Hex.Coordinates.Hex hex);

        void MoveNeuron(Hex.Coordinates.Hex from, Hex.Coordinates.Hex to, bool activate = false);
